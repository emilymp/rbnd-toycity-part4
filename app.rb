...
# Uncomment the following code once ALL your tests have passed!
 ...
 puts "-----------------"
 p Product.create(brand: "Udacity", name: "yoyo", price: 10.00)
 p Product.create(brand: "Bouncy", name: "ball", price: 12.00)
 p Product.create(brand: "MyCool", name: "dollhouse", price: 14.40)
 p Product.create(brand: "MySoft", name: "stuffed animal", price: 2.09)
 p Product.create(brand: "AllMy", name: "yoyo", price: 1.00)
 p Product.create(brand: "Udacity", name: "doll", price: 5.99)
